...
const META: Record<string, Meta> = {
  ...
  "email-newsletters":          { stack: "TBD",                           purpose: "Newsletter content aggregator",                   group: GROUP_OTHER, logo: { kind: "monogram", letter: "E", bg: "#a855f7", fg: "#f8fafc", as: "email-newsletters.svg" }, status: "wip" },
