...
const META: Record<string, Meta> = {
  ...
  "tbdc / workpro-queries":     { stack: "Bun, TS, tbqdc.com session",    purpose: "Ad-hoc queries against Workpro (tbqdc.com) clinic data", group: GROUP_TBDC, logo: TBDC_LOGO, status: "wip", commandsExclude: ["test-sheet-auth"] },
  "tbdc / web-legacy":          { stack: "PHP (legacy)",                  purpose: "Legacy TBDC clinic website",                      group: GROUP_TBDC, logo: TBDC_LOGO, status: "live", website: "https://www.toothboutiquedental.com/" },
  "tbdc / tbqdc-com":           { stack: "PHP, MySQL",                    purpose: "TBDC Workpro",                                    group: GROUP_TBDC, logo: TBDC_LOGO, status: "wip", website: "https://tbqdc.com/" },
  "tbdc / google-ads":          { stack: "Docs",                          purpose: "Google Ads research and planning for Tooth Boutique Dental", group: GROUP_TBDC, logo: { kind: "monogram", letter: "G", bg: "#d97757", fg: "#f8fafc", as: "google-ads.svg" }, status: "wip" },
  ...
  "padel-scrapers":             { stack: "Bun, TS (no deps), Python",     purpose: "Padel tournament/league scrapers → normalized Google Sheets (supercourt, cmpl, poddium, openrally, tps)", group: GROUP_MATCHDAY, logo: { kind: "monogram", letter: "P", bg: "#334155", fg: "#f8fafc", as: "padel-scrapers.svg" }, status: "wip" },
  "openrally-wpr":              { stack: "Static HTML, Vercel",           purpose: "WPR (World Padel Rating) integration + partnership research for OpenRally v3", group: GROUP_MATCHDAY, logo: MATCHDAY_LOGO, status: "wip", website: "https://openrally-wpr.vercel.app/", links: [{ label: "WPR Integration Brief", url: "https://openrally-wpr.vercel.app/" }, { label: "API Integration Guide", url: "https://openrally-wpr.vercel.app/integration" }, { label: "Tournated Teardown", url: "https://openrally-wpr.vercel.app/tournated" }] },
  "openrally-scout":            { stack: "Static HTML, Vercel",           purpose: "Competitor & partner teardowns — one <500-word page per padel product", group: GROUP_MATCHDAY, logo: MATCHDAY_LOGO, status: "live", website: "https://openrally-scout.vercel.app/", links: [{ label: "PadelLevels", url: "https://openrally-scout.vercel.app/padellevels" }, { label: "Padelfin", url: "https://openrally-scout.vercel.app/padelfin" }, { label: "PlayerData", url: "https://openrally-scout.vercel.app/playerdata" }, { label: "ScorePlay", url: "https://openrally-scout.vercel.app/scoreplay" }] },
  ...
  "padelthailand":              { stack: "HTML/CSS/JS, Leaflet",          purpose: "Tournament calendar for padel in Thailand",       group: GROUP_PADEL_THAILAND, logo: PADEL_THAILAND_LOGO, status: "live", gitExcludePaths: ["matchday", ".nojekyll"], website: "https://padelthailand.com/", links: [{ label: "Season Map", url: "https://padel-season-map.vercel.app" }, { label: "Partnership Network", url: "https://padel-partnership-network.vercel.app" }] },
  ...
  "padel-season-map":           { stack: "Python scrapers, D3, static HTML", purpose: "Interactive world map + timeline of FIP/Premier Padel seasons 2024-2026", group: GROUP_PADEL_THAILAND, logo: { kind: "monogram", letter: "P", bg: "#ef4444", fg: "#f8fafc", as: "padel-season-map.svg" }, status: "live", website: "https://padel-season-map.vercel.app" },
  "padel-partnership-network":  { stack: "Python scrapers, D3, static HTML", purpose: "Network dashboard of FIP pro-padel pair partnerships", group: GROUP_PADEL_THAILAND, logo: { kind: "monogram", letter: "P", bg: "#d97757", fg: "#f8fafc", as: "padel-partnership-network.svg" }, status: "live", website: "https://padel-partnership-network.vercel.app" },
  ...
  "email-newsletters":          { stack: "Bun, TS, IMAP",                 purpose: "Newsletter summarizer — daily digest of newsletters",  group: GROUP_PERSONAL, logo: { kind: "monogram", letter: "E", bg: "#a855f7", fg: "#f8fafc", as: "email-newsletters.svg" }, status: "wip" },
  ...
  "nest-dental":                { stack: "TBD",                           purpose: "Nest International Marketing Proposal",           group: GROUP_PERSONAL, logo: { kind: "monogram", letter: "N", bg: "#ef4444", fg: "#f8fafc", as: "nest-dental.svg" }, status: "wip" },
