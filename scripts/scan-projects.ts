...
const META: Record<string, Meta> = {
  ...
  "openrally-wpr":              { stack: "Static HTML, Vercel",           purpose: "WPR (World Padel Rating) integration + partnership research for OpenRally v3", group: GROUP_MATCHDAY, logo: MATCHDAY_LOGO, status: "wip", website: "https://openrally-wpr.vercel.app/", links: [{ label: "Tournated Teardown", url: "https://openrally-wpr.vercel.app/tournated" }] },
