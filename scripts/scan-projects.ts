...
const META: Record<string, Meta> = {
  ...
  "trip-planner":               { stack: "Claude Artifact",               purpose: "Verified trip itineraries with budget tracking",  group: GROUP_OTHER, logo: { kind: "monogram", letter: "T", bg: "#10b981", fg: "#f8fafc", as: "trip-planner.svg" }, status: "live", website: "https://claude.ai/code/artifact/f8efaa41-a16f-4b92-b720-07d8f0752b16" },
